      ...
      type hyd_output2
        ...
        real :: lag = 0.               !! tons          |detached large ag
        real :: grv = 0.               !! tons          |gravel
        real :: orgn_conc = 0.         !! deg c         |temperature
        real :: no3_conc = 0.          !! deg c         |temperature
        real :: solp_conc = 0.              !! deg c         |temperature
        real :: nh3_conc = 0.              !! deg c         |temperature
        real :: no2_conc = 0.              !! deg c         |temperature
        real :: tn_conc = 0.              !! deg c         |temperature
        real :: temp = 0.              !! deg c         |temperature
      end type hyd_output2
      ...
      type (hyd_output2), dimension(:), allocatable, save :: ch_out_d2
      ...
      type hyd_out_header2        
        ...
        character (len=15) :: lag_out  =    "        lag_out"        !! tons         |detached large ag out
        character (len=15) :: grv_out  =    "        grv_out"        !! tons         |gravel out
        character (len=15) :: orgn_out_conc =    "  orgn_out_conc"   !! mg N/l         |organic N out
        character (len=15) :: no3_out_conc =    "   no3_out_conc"    !! mg N/l         |organic N out
        character (len=15) :: solp_out_conc =    "  solp_out_conc"   !! mg N/l         |organic N out
        character (len=15) :: nh3_out_conc =    "   nh3_out_conc"    !! mg N/l         |organic N out
        character (len=15) :: no2_out_conc =    "   no2_out_conc"    !! mg N/l         |organic N out
        character (len=15) :: tn_out_conc =    "    tn_out_conc"     !! mg N/l         |organic N out
        character (len=15) :: temp_out =    "           null"        !! deg c        |temperature out
      end type hyd_out_header2
      type (hyd_out_header2) :: hyd_out_hdr2
      ...
      type hyd_header_units1_2
        ...
        character (len=15) :: grv    =  "           tons"        !! tons         |gravel
        character (len=15) :: temp   =  "               "        !! deg c        |temperature
        character (len=15) :: orgn_conc    =  "           mg/l"        !! tons         |detached silt
        character (len=15) :: no3_conc    =  "           mg/l"        !! tons         |detached clay
        character (len=15) :: solp_conc    =  "           mg/l"        !! tons         |detached small ag
        character (len=15) :: nh3_conc    =  "           mg/l"        !! tons         |detached large ag
        character (len=15) :: no2_conc    =  "           mg/l"        !! tons         |gravel
        character (len=15) :: tn_conc   =  "               "        !! deg c        |temperature        
        !Jaehak 2023
        !character (len=15) :: salt   =  "             kg"        !! deg c        |temperature
        !character (len=15) :: pest   =  "             mg"        !! deg c        |temperature
      end type hyd_header_units1_2
      type (hyd_header_units1_2) :: hyd_hdr_units1_2
