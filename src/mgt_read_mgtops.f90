      ...
      !! added by lichen lang read modal pdf fertilization parms
      call mpdf_fert_read
      ...
      do
       ...
       do isched = 1, imax
         read (107,*,iostat=eof)  sched(isched)%name, nops, sched(isched)%num_autos
         if (eof < 0) exit
