      ...
      ch_out_d2(isdch)%sed = ob(icmd)%hd(1)%sed          !set inflow om hydrograph
      ch_out_d2(isdch)%flo = ob(icmd)%hd(1)%flo / 86400.      !m3 -> m3/s
      ch_out_d2(isdch)%orgn = ob(icmd)%hd(1)%orgn 
      ch_out_d2(isdch)%sedp = ob(icmd)%hd(1)%sedp 
      ch_out_d2(isdch)%no3 = ob(icmd)%hd(1)%no3 
      ch_out_d2(isdch)%solp = ob(icmd)%hd(1)%solp 
      ch_out_d2(isdch)%chla = ob(icmd)%hd(1)%chla 
      ch_out_d2(isdch)%nh3 = ob(icmd)%hd(1)%nh3 
      ch_out_d2(isdch)%no2 = ob(icmd)%hd(1)%no2 
      ch_out_d2(isdch)%cbod = ob(icmd)%hd(1)%cbod 
      ch_out_d2(isdch)%dox = ob(icmd)%hd(1)%dox 
      ch_out_d2(isdch)%san = ob(icmd)%hd(1)%san 
      ch_out_d2(isdch)%sil = ob(icmd)%hd(1)%sil 
      ch_out_d2(isdch)%cla = ob(icmd)%hd(1)%cla 
      ch_out_d2(isdch)%sag = ob(icmd)%hd(1)%sag 
      ch_out_d2(isdch)%lag = ob(icmd)%hd(1)%lag 
      ch_out_d2(isdch)%grv = ob(icmd)%hd(1)%grv 
      ch_out_d2(isdch)%orgn_conc = 1000. * ob(icmd)%hd(1)%orgn / ob(icmd)%hd(1)%flo
      ch_out_d2(isdch)%no3_conc = 1000. * ob(icmd)%hd(1)%no3 / ob(icmd)%hd(1)%flo
      ch_out_d2(isdch)%solp_conc = 1000. * ob(icmd)%hd(1)%solp / ob(icmd)%hd(1)%flo
      ch_out_d2(isdch)%nh3_conc = 1000. * ob(icmd)%hd(1)%nh3 / ob(icmd)%hd(1)%flo
      ch_out_d2(isdch)%no2_conc = 1000. * ob(icmd)%hd(1)%no2 / ob(icmd)%hd(1)%flo
      if (ob(icmd)%hd(1)%flo > 1.e-6) then
        tn_mass = max(0., ob(icmd)%hd(1)%no2) + &
                  max(0., ob(icmd)%hd(1)%nh3) + &
                  max(0., ob(icmd)%hd(1)%no3) + &
                  max(0., ob(icmd)%hd(1)%orgn)
        ch_out_d2(isdch)%tn_conc = 1000. * tn_mass / ob(icmd)%hd(1)%flo
      else
        ch_out_d2(isdch)%tn_conc = 0.
      endif
      ch_out_d2(isdch)%temp = ob(icmd)%hd(1)%temp
