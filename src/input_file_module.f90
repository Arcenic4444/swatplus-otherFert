...
!! conditional 
 ...
 !! added by lichen lang, mpdf fert parameters 
      type input_mpdfer_params
       character(len=25) :: mpdf_param = "fert_mpdf_lumparam.txt"
      end type input_mpdfer_params
      type (input_mpdfer_params) :: in_mpdfer_params  
