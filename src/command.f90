          ...
          case ("chandeg")  !swatdeg channel
            ...
            if (sd_ch(isdch)%chl > 1.e-3) then
              call sd_channel_control3
                ...
                ch_out_d2(isdch)%sed = ht1%sed          !set inflow om hydrograph
                ch_out_d2(isdch)%flo = ht1%flo / 86400.      !m3 -> m3/s
                ch_out_d2(isdch)%orgn = ht1%orgn 
                ch_out_d2(isdch)%sedp = ht1%sedp 
                ch_out_d2(isdch)%no3 = ht1%no3 
                ch_out_d2(isdch)%solp = ht1%solp 
                ch_out_d2(isdch)%chla = ht1%chla 
                ch_out_d2(isdch)%nh3 = ht1%nh3 
                ch_out_d2(isdch)%no2 = ht1%no2 
                ch_out_d2(isdch)%cbod = ht1%cbod 
                ch_out_d2(isdch)%dox = ht1%dox 
                ch_out_d2(isdch)%san = ht1%san 
                ch_out_d2(isdch)%sil = ht1%sil 
                ch_out_d2(isdch)%cla = ht1%cla 
                ch_out_d2(isdch)%sag = ht1%sag 
                ch_out_d2(isdch)%lag = ht1%lag 
                ch_out_d2(isdch)%grv = ht1%grv 
                ch_out_d2(isdch)%orgn_conc = 1000. * ht1%orgn / ht1%flo
                ch_out_d2(isdch)%no3_conc = 1000. * ht1%no3 / ht1%flo
                ch_out_d2(isdch)%solp_conc = 1000. * ht1%solp / ht1%flo
                ch_out_d2(isdch)%nh3_conc = 1000. * ht1%nh3 / ht1%flo
                ch_out_d2(isdch)%no2_conc = 1000. * ht1%no2 / ht1%flo
                if (ht1%flo > 1.e-6) then
                  tn_mass = max(0., ht1%no2) + &
                            max(0., ht1%nh3) + &
                            max(0., ht1%no3) + &
                            max(0., ht1%orgn)
                  ch_out_d2(isdch)%tn_conc = 1000. * tn_mass / ht1%flo
                else
                  ch_out_d2(isdch)%tn_conc = 0.
                endif
                ch_out_d2(isdch)%temp = ht1%temp
